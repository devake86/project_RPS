...
def game_loop_sneak_a_peek_quiz_cache_clear_inmenu():

    with open("game_caches/game_loop_sneak_a_peek_quiz_cache.txt", "w"):
        pass



def game_loop_sneak_a_peek_quiz_cache_clear_ingame(input_lernfeld_de):
    ...
    while True:
        ...
        if int(input_delete_cache) == 1:
            ...
            # (cache_list.write(""))
            with open("game_caches/game_loop_sneak_a_peek_quiz_cache.txt", "w") as cache_list:
            ...
            input_lernfeld_de = game_menu_sneak_a_peek_ingame()
